...
We are importing code for the face detection task because it is not a focus
of the chosen paper.

Source of this code:
`GitHub ipazc/mtcnn <https://github.com/ipazc/mtcnn>`_
...
[images redacted to lighten size, see original]
